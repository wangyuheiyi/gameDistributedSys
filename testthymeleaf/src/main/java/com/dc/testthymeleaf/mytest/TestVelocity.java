...
public class TestVelocity {
	...
	private LogManagerBean generateTemplate(LogManagerBean logFileBean) throws IOException{
		...
		List<LogFieldBean> logBeanFieldList=new ArrayList<LogFieldBean>();
		...
		LogFieldBean logBeanField1=new LogFieldBean();
		...
		LogFieldBean logBeanField2=new LogFieldBean();
		...
		LogFieldBean logBeanField3=new LogFieldBean();
		...
		List<LogFieldBean> userLoginBeanFieldList=new ArrayList<LogFieldBean>();
		LogFieldBean userLoginBeanField=new LogFieldBean();
		...
		LogFieldBean userLoginBeanField1=new LogFieldBean();
		...
		LogFieldBean userLoginBeanField2=new LogFieldBean();
